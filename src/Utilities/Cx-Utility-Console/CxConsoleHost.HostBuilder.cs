...
/// </summary>
public sealed class CxConsoleBuilder
{
    
    private readonly IHostBuilder _hostBuilder;        
    private readonly List<KeyValuePair<string, string?>> _hostConfigurationValues;
    private CxConsoleApplication? _builtApplication;
    private IServiceCollection _services = new ServiceCollection();

   
    internal CxConsoleBuilder(string[]? Args, Action<IHostBuilder>? configureDefaults = null)
    {
        Services = _services;
        ...
        //_hostBuilder = Args.isNotNull() ? Host.CreateDefaultBuilder(Args) : Host.CreateDefaultBuilder()
        //    
    ...
    public CxConsoleApplication Build()
    {
